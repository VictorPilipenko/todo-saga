...
import { createAPI, markDoneAPI, deleteAPI } from '../../../api/restful/todo'
...
export const setCurrentPage = createAction(TYPES.QUERIES_SET_CURRENT_PAGE)
export const setPageSize = createAction(TYPES.QUERIES_SET_PAGE_SIZE)
