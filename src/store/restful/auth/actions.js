...
import {
  signUpAPI,
  signInAPI,
  passwordRecoveryStep1API,
  passwordRecoveryStep2API,
} from '../../../api/restful/auth'
...
export const passwordRecoveryStep1 = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_1_REQUEST
)
export const passwordRecoveryStep1Success = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_1_SUCCESS
)
export const passwordRecoveryStep1Failure = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_1_FAILURE
)

export const passwordRecoveryStep2 = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_2_REQUEST
)
export const passwordRecoveryStep2Success = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_2_SUCCESS
)
export const passwordRecoveryStep2Failure = createAction(
  TYPES.PASSWORD_RECOVERY_STEP_2_FAILURE
)
