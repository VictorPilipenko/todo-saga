        ...
        <Suspense fallback={<Loader />}>
          ...
          <Switch>
            ...
            <PublicRoute
              ...
              title="helmet.password.recover.title"
              description="helmet.password.recover.description"
            />
            <PublicRoute
              path="/password-change"
              component={PasswordChange}
              title="helmet.password.change.title"
              description="helmet.password.change.description"
            />
            <PrivateRoute
              path="/todo"
              component={ToDo}
              title="helmet.todo.title"
              description="helmet.todo.description"
            />
